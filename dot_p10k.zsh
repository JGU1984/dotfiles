# Generated by Powerlevel10k configuration wizard on 2022-12-13 at 00:33 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=226
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=20
  ...
  # Foreground color for the text git, on lefthand side, in status bar
